...
including both open-source models served via Ollama~(Gemma~3, Llama~3.1, DeepSeek-R1,
Mistral, Qwen~2.5) and proprietary models~(GPT-4o, GPT-3.5-Turbo). Two complementary
