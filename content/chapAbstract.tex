...
service tickets (multilingual email threads, attachments, and PDF documents) that are
...
constructed from three ticket categories and used to evaluate fifteen LLM configurations,
including both open-source models served via Ollama~(GPT-OSS~20B, Gemma~4, Gemma~7B,
Llama~3.1, Llama~3.2, DeepSeek-R1~7B/14B, Dolphin-Mixtral, Qwen~3, Qwen~2.5) and
proprietary models~(GPT-5.5, GPT-5.4-mini, GPT-4o, GPT-4o-mini, GPT-3.5-Turbo). Two complementary
...
tags from multilingual service tickets. Rule-based regex extraction is sufficient for
