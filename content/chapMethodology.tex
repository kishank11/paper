...
\begin{figure}[H]
    ...
    \caption[Total Gutschrift credit note value per year]{Total Gutschrift credit note value per year in EUR (2016 to 2025).}
    \label{fig:gs-money}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption[Total Belastungsanzeige cost per year]{Total Belastungsanzeige cost per year in 1000~EUR (2016 to 2025).}
    \label{fig:bl-cost}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/fig_ihre_teilenummer.png}
