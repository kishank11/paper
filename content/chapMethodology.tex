...
composition trend for each ticket category over the period 2016--2025.  The
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/gutschrift_file_format_trend.png}
    \caption{Gutschrift: file format composition trend (2016--2025).}
    \label{fig:gs-trend}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/belastungsanzeige_file_format_trend.png}
    \caption{Belastungsanzeige: file format composition trend (2016--2025).}
    \label{fig:bl-trend}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/lagerbelastung_file_format_trend.png}
    \caption{Lagerbelastung: file format composition trend (2016--2025).}
    \label{fig:lb-trend}
\end{figure}

Figures~\ref{fig:gs-records}--\ref{fig:lb-records} show the number of
records per year for each category.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/gutschrift_records_per_year.png}
    \caption{Gutschrift records per year (2016--2025).}
    \label{fig:gs-records}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/belastungsanzeige_records_per_year.png}
    \caption{Belastungsanzeige records per year (2016--2025).}
    \label{fig:bl-records}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/lagerbelastung_records_per_year.png}
    \caption{Lagerbelastung records per year (2016--2025).}
    \label{fig:lb-records}
\end{figure}

Figure~\ref{fig:gs-money} shows the total monetary value of Gutschrift
credit notes per year, peaking at over 9.1~million~EUR in T23~(2023).
Figure~\ref{fig:bl-cost} shows the total cost per year for Belastungsanzeige
charge notifications.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/gutschrift_money_spent.png}
    \caption{Total Gutschrift credit note value per year in EUR (2016--2025).}
    \label{fig:gs-money}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/belastungsanzeige_cost_per_year.png}
    \caption{Total Belastungsanzeige cost per year in 1000~EUR (2016--2025).}
    \label{fig:bl-cost}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/tool_tabula.png}
    \caption{Tabula output (6/15).  Tables are reconstructed but many cells are
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/tool_docling.png}
    \caption{Docling output (11/15).  Fields are linearised and table structure
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{figures/tool_spire.png}
    \caption{Spire output (11/15).  A flat, unstructured stream of values
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{figures/tool_pymupdf4llm.png}
    \caption{PyMuPDF4LLM output (15/15).  Header block and tabular structure are
...
Tickets were selected to ensure coverage of different years~(2016--2025),
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/benchmark_file_type_distribution.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.75\textwidth]{figures/ticket_classification.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{figures/file_distribution_per_ticket.png}
