...
composition trend for each ticket category over the period T16--T25.  The
...
\begin{figure}[H]
    ...
    \caption{Gutschrift: file format composition trend (T16--T25).}
    \label{fig:gs-trend}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Belastungsanzeige: file format composition trend (T16--T25).}
    \label{fig:bl-trend}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Lagerbelastung: file format composition trend (T16--T25).}
    \label{fig:lb-trend}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Gutschrift records per year (T16--T25).}
...
\begin{figure}[H]
    ...
    \caption{Belastungsanzeige records per year (T16--T25).}
...
\begin{figure}[H]
    ...
    \caption{Lagerbelastung records per year (T16--T25).}
...
\begin{figure}[H]
    ...
    \caption{Total Gutschrift credit note value per year in EUR (T16--T25).}
    \label{fig:gs-money}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Total Belastungsanzeige cost per year in 1000~EUR (T16--T25).}
    \label{fig:bl-cost}
\end{figure}
